...
const getApiRecipes =  async () => {
    ...
    const recipesUrl = await axios.get(`${API_URL}complexSearch?apiKey=${API_KEY10}&addRecipeInformation=true&number=100&offset=100`, {headers:{'Accept-Encoding': 'identity'}});
